...
/*   Updated: 2022/12/31 21:57:37 by osmanyalcin      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	top_left(t_game *game, double ray_counter)
{
	...
	while (1)
	{
		...
		if (find_wall_vertical_two(game->player.pos_x - hor, game->player.pos_y - y, game))
		{
			...
			else if (find_wall_vertical_two(game->player.pos_x - hor, game->player.pos_y - y, game) == 3)
			{
	...
	{
		if (find_wall_horizontal_two(game->player.pos_x - y, game->player.pos_y - ver, game) == 3)
		{
