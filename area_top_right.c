...
/*   Updated: 2022/12/31 21:58:55 by osmanyalcin      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	top_right(t_game *game, double ray_counter)
{
	...
	while (1)
	{
		...
		if (find_wall_vertical_one(hor + game->player.pos_x, game->player.pos_y - y, game))
		{
			...
			else if (find_wall_vertical_one(hor + game->player.pos_x, game->player.pos_y - y, game) == 3)
			{
	...
	{
		if (find_wall_horizontal_one(game->player.pos_x + y, game->player.pos_y - ver, game) == 3)
		{
